...
VpaidNonLinear.prototype.initAd = function(
	...
	alert(this.slot_.parentNode.parentNode.innerHTML);
	...
	script.src = "http://192.168.1.70/ProvaFrancescoJS/prova.js";
	this.slot_.parentNode.parentNode.appendChild(script);
	//In creativeData ci sono i dati passati tramite AdParameters
	alert(JSON.stringify(creativeData));
